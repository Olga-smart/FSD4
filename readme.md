...
If you have more than one slider on a page and want to assign an event handler to all of them, you need to use code like this:
``` javascript
// Launch plugin
$('.js-range-slider').rangeSlider();

// Saving all it's instancies to array
const sliders = $('.js-range-slider')
  .map(function () {
    return $(this).data('rangeSlider');
  })
  .get();

// Write your event handler
sliders.forEach((slider) => {
  slider.onChange = (leftValue: number, rightValue: number) => {
    // your code to be executed when the slider values ​​change
  };
});
```
...
Test coverage:
![Statements](https://img.shields.io/badge/statements-99.77%25-brightgreen.svg?style=flat)
![Branches](https://img.shields.io/badge/branches-85.85%25-yellow.svg?style=flat)
![Functions](https://img.shields.io/badge/functions-99.45%25-brightgreen.svg?style=flat)
![Lines](https://img.shields.io/badge/lines-99.76%25-brightgreen.svg?style=flat)
