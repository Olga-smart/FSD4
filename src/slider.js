...
const getTemplate = (options) => {
  let result = `
    ...
    <div class="range-slider__slider">
      ...
      <div class="range-slider__thumb range-slider__thumb_left js-range-slider__thumb_left"></div>
      <div class="range-slider__thumb range-slider__thumb_right js-range-slider__thumb_right"></div>
    </div>
  `
  if (options.minMaxLabels) {
    result += `
